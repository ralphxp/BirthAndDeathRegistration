      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> BIRTH REGISTRATION</h4>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name= 'fathersName' required class="form-control" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name= 'mothersName' required class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" required name="dob" type="date" placeholder="dd/mm/yyyy" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input  type="date" name = "yob" required class="form-control" placeholder="dd/mm/yyyy"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
...
//code for validation of fields goes here
                    ...
                    $query = mysqli_query($con,"SELECT  * from tblcertno where certId = '100000'") or die(mysqli_error());
                        $row = mysqli_fetch_array($query);
                        $numberOfRows = mysqli_num_rows($query);				
		
                       $newCertNo  = $row['lastCertId']  + 1;  

   $resultt = mysqli_query($con, "UPDATE tblcertno set lastCertId='$newCertNo' where certId = '100000'") or die(mysqli_query());

                       if($resultt > 0){
                                  


                    $result =  mysqli_query($con,"INSERT into tblbirth (certNo,firstName,lastName,fathersName,mothersName,gender,genotype,weight,birthPlace,state,lga,dateOfBirth,yearOfBirth,PlaceOfIssue,regCentre,dateReg)
                            	values ('$newCertNo','$firstName','$lastName','$fathersName','$mothersName','$gender','$genotype','$weight','$bPlace','$state','$lga','$dob','$yob','$Placeissue','$regCentre','$dateReg')
                                ") or die(mysqli_error());
