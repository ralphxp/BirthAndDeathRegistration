        ...
        ?>
          ...
          <div class="col-12 grid-margin" >
              <div class="card" >
                ...
                <div class="card-title" style="margin-left:520px"><u><h4>CERTIFICATE OF BIRTH</h4></u></div>
                  <form class="form-sample" method="post" action="BirthRegistration.php">
                    ...
                    <p class="card-description">
                    <div style="margin-left:5px"><h6>This is to certify that the birth details of which are recorded herein, has been registered on <u> <?php echo $row['dateReg'];?></u> at this Registration Centre</h6><br>
                    </p>
                    <div class="row">
                      <div class="col-md-6">
                        <!-- <div class="form-group row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">3. Date Of Birth</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">4. Place of Bith</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">5. Full Name Of Father:</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">6. Full Name Of Mother:</label>
                          <div class="col-sm-9">
