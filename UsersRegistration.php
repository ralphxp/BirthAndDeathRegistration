...
//code for validation of fields goes here
                                ...
                                $querys = mysqli_query($con, "SELECT  * from tbladmin where email ='$email'") or die(mysqli_error());
                    ...
                    $result =  mysqli_query($con, "INSERT into tbladmin (email,username,password,role,RegCentre,dateReg)
